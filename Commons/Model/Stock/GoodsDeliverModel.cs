...
{
    public class GoodsDeliverModel
    {
    }

    #region 发货头命令
    public class DeliveryHeaderCommand
    {
        /// <summary>
        /// 单号
        /// </summary>
    ...
    #region 命令头详细对象数据
    public class DeliveryHeaderDetailCommand : DeliveryHeaderCommand
    {
        /// <summary>
        /// 收货门店
        /// </summary>
    ...
    #region 发货行命令
    public class DeliveryItemCommand
    {
        /// <summary>
        /// 单号
        /// </summary>
    ...
    #region 命令行详细对象数据
    public class DeliveryItemDetailCommand : DeliveryItemCommand
    {
        /// <summary>
        /// 商品名称
        /// </summary>
        ...
        /// 可用库存
        /// </summary>
        public int? availableStock { get { return onHand - promise; } }
    }
    #endregion
    ...
    #region 发货头明细数据
    public class DeliveryHeaderDetail : DeliveryHeader
    {
        /// <summary>
        /// 收货店铺名称
        /// </summary>
    ...
    #region 发货行明细
    public class DeliveryItemDetail : DeliveryItem
    {
        /// <summary>
        /// 出库仓库名称
        /// </summary>
