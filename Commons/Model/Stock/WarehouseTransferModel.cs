...
namespace Commons.Model.Stock
{
    ...
    #region 发货头命令
    public class TransferHeaderCommand
    {
        /// <summary>
        /// 单号
        /// </summary>
    ...
    #region 命令头详细对象数据
    public class TransferHeaderDetailCommand : TransferHeaderCommand
    {
        /// <summary>
        /// 收货门店
        /// </summary>
    ...
    #region 命令行详细对象数据
    public class TransferItemDetailCommand : TransferItemCommand
    {
        /// <summary>
        /// 商品名称
        /// </summary>
    ...
    #region 发货头明细数据
    public class TransferHeaderDetail : TransferHeader
    {
        /// <summary>
        /// 收货店铺名称
        /// </summary>
    ...
    #region 发货行明细
    public class TransferItemDetail : TransferItem
    {
        /// <summary>
        /// 出库仓库名称
        /// </summary>
